...
namespace DungeonDigger.Generation
{
  ...
  /*  public class Elimination2 : IGenerator
    {
        private Random rnd = new Random();
        private const string HeightKey = "Height";
        private const string WidthKey = "Width";
        private const string MaxRSKey = "MaxRoomSize";
        private const string MinRSKey = "MinRoomSize";
        private Tile[,] Map; //make private
        private bool Fullgen;
        private int MaxRS;
        private int MinRS;
        ...
        public Elimination2(IDictionary<string, object> options)
        {
            Map = new Tile[int.Parse(options[HeightKey].ToString()), int.Parse(options[WidthKey].ToString())];
            Fullgen = true;
            MaxRS = int.Parse(options[MaxRSKey].ToString());
            MinRS = int.Parse(options[MinRSKey].ToString());
        }
